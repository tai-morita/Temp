...
* 备    注:
*********************************************************/
HBI_FPD_DLL int __stdcall HBI_SetSysParamCfg(void *handle, int cmd, int type, RegCfgInfo* pRegCfg = NULL);
...
* 备    注:
*********************************************************/
HBI_FPD_DLL int __stdcall HBI_GenerateDefectTemp(void *handle, int group_sum, int per_group_num, int bprevew = 0, int bolckSize = 70);
...
* 备    注:
*********************************************************/
HBI_FPD_DLL int __stdcall HBI_SwitchUserMode(void* handle, unsigned int modeid = 0, FPD_MODE_DATA* PMODEDATA = NULL, bool enableCorrection = false);
...
* Comment:
*********************************************************/
HBI_FPD_DLL int __stdcall HBI_GetCurModeTemplateStatus(void* handle, int* nTempStatus, int currentID = -1);
//////////////////////////////////////////////////////////////////////////
...
* Function Description: Set the detector to sleep
* Parameter Description:
		In: void *handle - unsigned handle pointer
* Return Value：int
		   0: Success
...
* Function Description: Wake up tablet from sleep
* Parameter Description:
		In: void *handle - unsigned handle pointer
* Return Value：int
* 		   0: Success
...
/*********************************************************
* No: No205
* Function Name: HBI_GetCurTemperatureBatteryInfo
* Function Description: Obtain temperature and battery information
* Parameter Description:
	In: void *handle - unsigned handle pointer
* Return Value：int
		   0: Success
		   Non-0: Failure
* Comment: Asynchronous function, feedback through callback function，Reference callback event 'ECALLBACK_TEMPERATURE_BATTERY_INFO'
* 编    号: No205
* 函 数 名: HBI_GetCurTemperatureBatteryInfo
* 功能描述: 获取温度和电池信息
* 参数说明:
	In: void *handle - 句柄(无符号指针)
* 返 回 值：int
	0   - 成功
	非0 - 失败
* 备    注: 异步函数，通过回调函数反馈,见回调事件ECALLBACK_TEMPERATURE_BATTERY_INFO
*********************************************************/
HBI_FPD_DLL int __stdcall HBI_GetCurTemperatureBatteryInfo(void* handle);

/*********************************************************
* No: No206
* Function Name: HBI_IsInSleepMode
* Function Description: Determine whether the current detector is in sleep mode
* Parameter Description:
	In: void *handle - unsigned handle pointer
	Out:None
* Return Value：int
...
* Comment:
* 编    号: No206
* 函 数 名: HBI_IsInSleepMode
* 功能描述: 判断当前探测器是否处于休眠模式
* 参数说明:
	In: void *handle - 句柄(无符号指针)
	Out:无
* 返 回 值：int
...
* 备    注:
*********************************************************/
HBI_FPD_DLL int __stdcall HBI_IsInSleepMode(void* handle);

/*********************************************************
* No: No207
* Function Name: HBI_Set2SleepMode
* Function Description: Determine whether the current detector is in sleep mode
* Parameter Description:
	In: void *handle - unsigned handle pointer
		int nmode - Sleep or wake-up mode parameters, default 1 is sleep mode, 0 or other is wake-up mode
	Out:None
* Return Value：int
		   0: Success
		   Non-0: Failure
* Comment:
* 编    号: No207
* 函 数 名: HBI_Set2SleepMode
* 功能描述: 将探测器设置为休眠模式或唤醒模式
* 参数说明:
	In: void *handle - 句柄(无符号指针)
	    int nmode - 休眠或唤醒模式参数，默认1为休眠模式，0或其他为唤醒模式
	Out:无
* 返 回 值：int
	0   - 成功
	非0 - 失败
* 备    注:
*********************************************************/
HBI_FPD_DLL int __stdcall HBI_Set2SleepMode(void* handle, int nmode=1);

/*********************************************************
* No: No208
* Function Name: HBI_GetUdpMtuPacketType（newly increased）
* Function Description: Get the packet type of UDP maximum transmission unit
* Parameter Description:
		In: void *handle  - unsigned handle pointer
		In/Out: int *npacketType - MTU type，0-udp packet;1-udp packet jumbo;others-"udp packet°;
* Return Value：int
		   0: Success
		   Non-0: Failure
* Comment:
* 编    号: No208
* 函 数 名: HBI_GetUdpMtuPacketType（新增）
* 功能描述: 获取UDP最大传输单元的数据包类型
* 参数说明:
		In: void *handle  - 句柄(无符号指针)
		In/Out: int *npacketType -  MTU类型（巨帧和非巨帧） 0-udp packet;1-udp packet jumbo;0 or others-"udp packet;
* 返 回 值：int
		0   - 成功
		非0 - 失败
* 备    注:
*********************************************************/
HBI_FPD_DLL int __stdcall HBI_GetUdpMtuPacketType(void* handle, int *npacketType);

/*********************************************************
* No: No209
* Function Name: HBI_SetWindowMode
* Function Description:
* Parameter Description:
	In: void *handle - unsigned handle pointer
	bool isWindowMode - true:enable,false-disable
	Out:None
* Return Value：int
		   0: Success
		Non-0: Failure
* Comment:
* 编    号: No209
* 函 数 名: HBI_SetWindowMode
* 功能描述: 曝光窗口模式使能
* 参数说明:
	In: void *handle - 句柄(无符号指针)
		bool isWindowMode, - 启用、禁用
			true：启用
			false：禁用
	Out:无
* 返 回 值：int
...
* 备    注:
*********************************************************/
HBI_FPD_DLL int __stdcall HBI_SetWindowMode(void* handle, bool isWindowMode);

/*********************************************************
* No: No210
* Function Name: HBI_GetWindowMode
* Function Description:
* Parameter Description:
	In: void *handle - unsigned handle pointer
	In/Out	bool *isWindowMode - true:enable,false-disable
	Out:None
* Return Value：int
		   0: Success
		Non-0: Failure
* Comment:
* 编    号: No210
* 函 数 名: HBI_GetWindowMode
* 功能描述: 获取曝光窗口模式使能状态
* 参数说明:
	In: void *handle - 句柄(无符号指针)
	In/Out	bool *isWindowMode, - 启用、禁用
			true：启用
			false：禁用
	Out:无
* 返 回 值：int
...
* 备    注:
*********************************************************/
HBI_FPD_DLL int __stdcall HBI_GetWindowMode(void* handle, bool* isWindowMode);

/*********************************************************
* No: No211
* Function Name: HBI_SetBinningDivisor
* Function Description:
* Parameter Description:
	In: void *handle - unsigned handle pointer
		unsigned char binDiv,[0,1,2,4,8,16]
	Out:None
* Return Value：int
		   0: Success
		Non-0: Failure
* Comment:
* 编    号: No211
* 函 数 名: HBI_SetBinningDivisor
* 功能描述: 设置binning模式下除数因子
* 参数说明:
	In: void *handle - 句柄(无符号指针)
		unsigned char binDiv- 除数因子，范围[0,1,2,4,8,16]
	Out:无
* 返 回 值：int
	0   - 成功
	非0 - 失败
* 备    注:
*********************************************************/
HBI_FPD_DLL int __stdcall HBI_SetBinningDivisor(void* handle, unsigned char binDiv);

/*********************************************************
* No: No212
* Function Name: HBI_GetBinningDivisor
* Function Description:
* Parameter Description:
	In: void *handle - unsigned handle pointer
	In/Out	unsigned char* binDiv,[0,1,2,4,8,16]
	Out:None
* Return Value：int
		   0: Success
		Non-0: Failure
* Comment:
* 编    号: No212
* 函 数 名: HBI_GetBinningDivisor
* 功能描述: 获取binning模式下除数因子
* 参数说明:
	In: void *handle - 句柄(无符号指针)
	In/Out	unsigned char* binDiv -- 除数因子，范围[0,1,2,4,8,16]
	Out:无
* 返 回 值：int
	0   - 成功
	非0 - 失败
* 备    注:
*********************************************************/
HBI_FPD_DLL int __stdcall HBI_GetBinningDivisor(void* handle, unsigned char* binDiv);

/*********************************************************
* No: No213
* Function Name: HBI_SetTiCofDAC
* Function Description:
* Parameter Description:
	In: void *handle - unsigned handle pointer
		unsigned short dacV
...
* Comment:
* 编    号: No213
* 函 数 名: HBI_SetTiCofDAC
* 功能描述: 设置Read电压DAC值
* 参数说明:
	In: void *handle - 句柄(无符号指针)
		unsigned short dacV -Read电压DAC值，范围[0,0XFFFF]
	Out:无
* 返 回 值：int
	0   - 成功
	非0 - 失败
* 备    注:
*********************************************************/
HBI_FPD_DLL int __stdcall HBI_SetTiCofDAC(void* handle, unsigned short dacV);

/*********************************************************
* No: No214
* Function Name: HBI_GetTiCofDAC
* Function Description:
* Parameter Description:
	In: void *handle - unsigned handle pointer
	In/Out	unsigned short *dacV
	Out:None
* Return Value：int
		   0: Success
		Non-0: Failure
* Comment:
* 编    号: No214
* 函 数 名: HBI_GetTiCofDAC
* 功能描述: 获取Read电压DAC值
* 参数说明:
	In: void *handle - 句柄(无符号指针)
	In/Out	unsigned char* binDiv -Read电压DAC值，范围[0,0XFFFF]
	Out:无
* 返 回 值：int
	0   - 成功
	非0 - 失败
* 备    注:
*********************************************************/
HBI_FPD_DLL int __stdcall HBI_GetTiCofDAC(void* handle, unsigned short* dacV);

/*********************************************************
* No: No215
* Function Name: HBI_IsEnableReturnImage
* Function Description: Determine whether the current SDK is providing feedback on image data
* Parameter Description:
	In: void *handle - unsigned handle pointer
	Out:None
* Return Value：int
...
* Comment:
* 编    号: No205
* 函 数 名: HBI_IsEnableReturnImage
* 功能描述: 判断当前SDK是否反馈图像数据
* 参数说明:
	In: void *handle - 句柄(无符号指针)
	Out:无
* 返 回 值：int
...
* 备    注:
*********************************************************/
HBI_FPD_DLL int __stdcall HBI_IsEnableReturnImage(void* handle);

/*********************************************************
* No: No216
* Function Name: HBI_EnableReturnImage
* Function Description: Control the switch for SDK feedback image data
* Parameter Description:
	In: void *handle - unsigned handle pointer
		unsigned short usdeviceid,refer to biType.h，pciedeviceidTable[PCIE_DEVID_MAX_NUMBER]。
			int nEnable, - Control switch parameters，default 1
				0: No feedback on image data
				1: Feedback image data
	Out:None
* Return Value：int
		   0: Success
		Non-0: Failure
* Comment:
* 编    号: No206
* 函 数 名: HBI_EnableReturnImage
* 功能描述: 控制SDK反馈图像数据的开关
* 参数说明:
	In: void *handle - 句柄(无符号指针)
		int nEnable, - 反馈图像数据的使能参数，默认为1
			0：不反馈图像数据
			1：反馈图像数据
	Out:无
* 返 回 值：int
...
* 备    注:
*********************************************************/
HBI_FPD_DLL int __stdcall HBI_EnableReturnImage(void* handle, int nEnable = 1);

/*********************************************************
* No: No217
* Function name: HBI_FrameLossDetectEnable
* Function description: Enable frame loss detection (newly added)
* Parameter Description:
	In: void * handle - Handle (unsigned pointer)
		unsigned int nDetectEnable - enable type,0:Disable,other:Enable.
	Out: None
* Return value: int
		0- Success
		Non 0- Failed
* Remarks:
* No: No216
* 函 数 名: HBI_FrameLossDetectEnable
* 功能描述: 丢帧检测开关使能
* 参数说明:
	In: void * handle - 句柄(无符号指针)
		unsigned int nDetectEnable - 丢帧检测使能开关,0:启用,其他:不启用
		Out: 无
* 返 回 值：int
		0   - 成功
		非0 - 失败
* 备    注:
*********************************************************/
HBI_FPD_DLL int __stdcall HBI_FrameLossDetectEnable(void* handle, unsigned int nDetectEnable);

////////////////////////////////////////////////////////////////////////
HBI_FPD_DLL int __stdcall HBI_RestartPcieDevice(void* handle);
HBI_FPD_DLL int __stdcall HBI_SendData(void* handle, unsigned char cmd=0, unsigned char* id=NULL, unsigned char* data = NULL, unsigned int datalen = NULL);
HBI_FPD_DLL int __stdcall HBI_SetRetransMissPacket(void* handle, unsigned int startpackagenum, unsigned int endpackagenum);
HBI_FPD_DLL bool __stdcall HBI_GetEnableStatusOfFrameLoss(void* handle);
HBI_FPD_DLL int __stdcall HBI_EnableFrameLossCheck(void* handle, bool bcheck);
HBI_FPD_DLL int __stdcall HBI_FeedbackFrameLoss(void* handle);
HBI_FPD_DLL int __stdcall HBI_SaveFrameLossInfo(void* handle);
HBI_FPD_DLL int __stdcall HBI_UpdateFPDSerialNumberEx(void* handle, char* szSn, int cmd);
HBI_FPD_DLL int __stdcall HBI_RomCfg2FactoryCfg(void* handle);
////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////

HBI_FPD_DLL int __stdcall HBI_UpdateCurrentTemplateStatus(void* handle, unsigned int status, int currentID = -1);
/*********************************************************
* 编    号: No216
* 函 数 名: HBI_WriteModeListFile
* 功能描述: 写入模板文件
* 参数说明:
	In: void *handle - 句柄(无符号指针)
	In：	char* filePath 写入模板文件路径
	In：bool isCleanFile 写入前是否清空模板文件内容
* 返 回 值：int
	0   - 成功
	非0 - 失败
* 备    注:
*********************************************************/
HBI_FPD_DLL int __stdcall HBI_WriteModeListFile(void* handle, char* filePath = NULL, bool isCleanFile = false);
/*********************************************************
* 编    号: No217
* 函 数 名: HBI_ReadModeListFile
* 功能描述: 读取模板文件
* 参数说明:
	In: void *handle - 句柄(无符号指针)
	In：	char* filePath 读取模板文件路径
* 返 回 值：int
	0   - 成功
	非0 - 失败
* 备    注:
*********************************************************/
HBI_FPD_DLL int __stdcall HBI_ReadModeListFile(void* handle, char* filePath = NULL);
HBI_FPD_DLL char* __stdcall HBI_GetCurTempFolderName(void* handle, char* buff);
HBI_FPD_DLL char* __stdcall HBI_GetSelectedTempFolderName(void* handle, int index ,char* buff);
/*********************************************************
* 编    号: No218
* 函 数 名: HBI_GetModeList
* 功能描述: 读取模板文件
* 参数说明:
	In: void *handle - 句柄(无符号指针)
	Out：void* modeList 返回所有模板拷贝，用于界面显示
* 返 回 值：int
	0   - 成功
	非0 - 失败
* 备    注:
* *********************************************************/
HBI_FPD_DLL int __stdcall HBI_GetModeList(void* handle, void* modeList);
HBI_FPD_DLL int __stdcall HBI_ModifyModebyID(void* handle, int id, FPD_MODE_DATA mode);
HBI_FPD_DLL int __stdcall HBI_GetPfsEffectTempFolderName(void* handle, bool* isEffect);
HBI_FPD_DLL int __stdcall HBI_SetMutexLock(void* handle); 
HBI_FPD_DLL int __stdcall HBI_SetMutexUnlock(void* handle);
////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////
/***************************************************************************************
////////////////////////////////////////////////////////////////////////////////////////
